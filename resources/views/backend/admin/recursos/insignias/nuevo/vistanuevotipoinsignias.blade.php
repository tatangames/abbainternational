...
<div id="divcontenedor" style="display: none">
        ...
        <div class="container-fluid">
            <div class="card card-success">
                <div class="card-header">
                    <h3 class="card-title">Crear Nueva Insignia</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <section style="margin-top: 15px">
                                <div class="row">
                                    <div class="form-group">
                                        <div class="form-group">
                                            <label class="control-label">Imagen (Ejemplo: 600x600 px)</label>
    ...
    <div class="modal-footer justify-content-between float-right" style="margin-top: 25px; margin-bottom: 30px;">
        <button type="button" class="btn btn-success" onclick="preguntarGuardar()">Guardar Insignia</button>
    </div>
...
@section('archivos-js')
    ...
    <script>
        ...
        function guardarPlanFinal(){
            ...
            axios.post('/admin/tipoinsignias/registrar', formData, {
            })
                .then((response) => {
                    closeLoading();
                    ...
                    if(response.data.success === 1){
                        Swal.fire({
                            ...
                            text: "Se deberan registrar los niveles",
                            icon: 'success',
